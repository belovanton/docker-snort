...
#RUN echo "output alert_unified2: filename snortalert.unified2" >> /etc/snort/snort.conf
#RUN echo "output log_unified2: filename snortlog.unified2" >>  /etc/snort/snort.conf
#RUN echo "output unified2: filename mergedlog.unified2" >> /etc/snort/snort.conf
